...
| ファイル名 | 説明 |
|------------|------|
| csv-translation.py | コマンドライン（CLI）版のメインスクリプト |
| csv-translation-gui.py | グラフィカルインターフェース（GUI）版のスクリプト |
...
| **CSVファイルを読み込めません** | ファイルの正しいエンコーディングを指定するか、自動検出を選択してください。 |
